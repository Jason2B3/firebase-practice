...
//# SUMMARY 
// ARG 1: An async function that makes an HTTP request
...
// It returns a new function sendRequest, plus all the state object keys

// sendRequest Returned
// only requires an argument if the fetch function you feed use-http requires one